...
wget -O /data/scigraph.tgz http://scigraph-ontology-dev.monarchinitiative.org/static_files/scigraph.tgz 
...
/data/solr-6.2.1/bin/solr stop
cd /data/solr-6.2.1/server/solr && tar czfv search.tgz search/
